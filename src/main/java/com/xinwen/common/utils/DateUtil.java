...
public class DateUtil {
    ...
    public static String getDate(String format) {
        ...
        return simple.format((new com.xinwen.common.utils.DateUtil()).calendar.getTime());
    }
...
//    	return strDay + " " + strHour + ":" + strMinute + ":" + strSecond + " " + strMilliSecond;
    ...
    public static String strToDateToFormat(String str){
    	...
    	try {
			...
			LogUtil.intoLog(com.xinwen.common.utils.DateUtil.class,"转换失败");
			e.printStackTrace();
		}
    	return null;
    }
    ...
    public static int getYear() {
        return (new com.xinwen.common.utils.DateUtil()).calendar.get(Calendar.YEAR) ;
    }
 
    public static int getMonth() {
        int month = (new com.xinwen.common.utils.DateUtil()).calendar.get(Calendar.MONTH) + 1;
        return month ;
    }
 
    public static int getDay() {
        return (new com.xinwen.common.utils.DateUtil()).calendar.get(Calendar.DATE) ;
    }
 
    public static String get24Hour() {
        return (new com.xinwen.common.utils.DateUtil()).calendar.get(Calendar.HOUR_OF_DAY) + "";
    }
 
    public static String getMinute() {
        return (new com.xinwen.common.utils.DateUtil()).calendar.get(Calendar.MINUTE) + "";
    }
    ...
    public static String getDefaultDateFormat(long aDate) {
		...
		return com.xinwen.common.utils.DateUtil.format(date);
	}
    
    public static String getYear(Date date) {
		String currentTime = com.xinwen.common.utils.DateUtil.getDefaultDateFormat(date.getTime());
    ...
    public static String getSecond() {
        return (new com.xinwen.common.utils.DateUtil()).calendar.get(Calendar.SECOND) + "";
    }
    
    public static String getMILLISECOND() {
        return (new com.xinwen.common.utils.DateUtil()).calendar.get(Calendar.MILLISECOND) + "";
    }
